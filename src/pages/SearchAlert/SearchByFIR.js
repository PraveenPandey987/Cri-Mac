...
function SearchByFIR() {
  ...
  async function updateSearch() {
    let data = await fetch("http://localhost:3080/api/");
  }
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ padding: "5px" }}>Search by FIR</span>
      </div>
      ...
      <Grid container spacing={2} style={{ marginTop: "1em", width: "100%" }}>
        ...
        <Grid item xs={8} style={{ padding: "1em 20px 1em 0" }}>
          ...
          >
            Note: 14 digits (2 digits of state + 3 digits of district + 3 digits
            of PS + 2 digits of year + 4 digits of year)
          </div>
        </Grid>
      </Grid>
      <div
